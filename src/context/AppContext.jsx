...
const translations = {
  en: {
    ...
    featCommunityDesc: "Create or join live circles to recite Quran, memorize together, count group Tasbih, and share faith-based reflections.",
    featArticlesTitle: "Islamic Articles & Arabic Learning",
    featArticlesDesc: "Explore well-researched guides on Islamic history, daily du'as, faith goals, and learning the Arabic language.",
    ...
    commPostPlaceholder: "What reflection or verse would you like to share today?",
  ...
  ar: {
    ...
    artSubtitle: "أنر عقلك بالمقالات التعليمية والدينية المتميزة",
    ...
    commPostPlaceholder: "اكتب ما تود مشاركته مع الآخرين حتى تعم الفائدة",
  ...
  const [onlineCircles, setOnlineCircles] = useState(() => {
    ...
    return [
      ...
      },
      {
        ...
        descriptionAr: "قراءة جماعية لسورة الملك قبل النوم",
        capacity: 5,
        duration: 60,
        currentTurnIndex: 0,
        sessionProgress: 8,
